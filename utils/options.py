...
def get_args():
    ...
    # Custom
    # Switches
    parser.add_argument("--enable_ccd", action='store_true')
    parser.add_argument("--enable_tse", action='store_true')
    parser.add_argument("--enable_reexpress", action='store_true')
    parser.add_argument("--enable_calssifier", action='store_true')
    parser.add_argument("--enable_reranking", action='store_true')
    parser.add_argument("--enable_vdt", action='store_true')
    parser.add_argument("--enable_loss_view", action='store_true')
    parser.add_argument("--dualstream", action='store_true', help="whether to use dual-stream architecture", default=False)
    parser.add_argument("--enable_text_aerial", action='store_true')
    # Scaling factors
    parser.add_argument("--scale_reexpress", type=float, default=1.0, help="scaling factor for re-express loss")
    parser.add_argument("--scale_calssifier", type=float, default=1.0, help="scaling factor for classifier loss")
    parser.add_argument("--scale_vdt", type=float, default=1.0, help="scaling factor for vdt loss")
    parser.add_argument("--scale_loss_view", type=float, default=1.0, help="scaling factor for view loss")
    # Others
    parser.add_argument("--source_aerial", type=str, default="", help="aerial image annotation file for aerial-image alignment")
